...
bag = BaggingClassifier(estimator=tree, #The original code is base_extimator=tree
                        n_estimators=500, 
                        max_samples=1.0, 
                        max_features=1.0, 
                        bootstrap=True, 
...
ada = AdaBoostClassifier(estimator=tree, #The original code is base_extimator=tree
                         n_estimators=500, 
                         learning_rate=0.1,
                         random_state=1)
