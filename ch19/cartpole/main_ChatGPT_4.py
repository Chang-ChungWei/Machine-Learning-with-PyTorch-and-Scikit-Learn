# -*- coding: utf-8 -*-
"""
Created on Sun Jul 28 17:44:47 2024
...
if __name__ == '__main__':
    ...
    model = DQN('MlpPolicy', env, verbose=1, learning_rate=1e-4, buffer_size=10000, learning_starts=1000, batch_size=64, gamma=0.99, train_freq=1, target_update_interval=100, exploration_fraction=0.1, exploration_final_eps=0.02)
