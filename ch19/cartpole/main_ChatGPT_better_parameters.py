# -*- coding: utf-8 -*-
"""
Created on Sun Jul 28 18:07:43 2024
...
class DQNAgent:
    def __init__(
            ...
            max_memory_size=2000, target_update_interval=10):
        self.env = env
    ...
    def _build_nn_model(self):
        ...
        self.target_model = nn.Sequential(nn.Linear(self.state_size, 256),
                                          nn.ReLU(),
                                          nn.Linear(256, 128),
                                          nn.ReLU(),
                                          nn.Linear(128, 64),
        ...
        for transition in batch_samples:
            ...
            with torch.no_grad():
                if done:
                    ...
                    pred_next = self.target_model(next_s_tensor)
    ...
    for e in range(EPISODES):
        ...
        for i in range(500):
            ...
            if done:
                ...
                print(f'Episode: {e}/{EPISODES}, Total reward: {episode_reward}')
                break
